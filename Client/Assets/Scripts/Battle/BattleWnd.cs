...
public class BattleWnd 
{
    ...
    public BattleWnd()
    {
         GameObject go = LuaHelper.GetResManager().LoadAsset<GameObject>("UI", "BattleWnd", "BattleWnd");
        _transform = GameObject.Instantiate(go).transform;
    ...
    public void CreateBloodText(Character ch, int hp, BloodTextType type)
    {
        ...
        LuaTimerManager.instance.Invoke(1.0f, () =>
        {
    ...
    public static Vector3 WorldToScreenPosition(Vector3 position)
    {
        ...
        Vector3 uipoint = _uicamera.ScreenToWorldPoint(screenPosition);
        uipoint.z = 0;
        return uipoint;
    }
    ...
    public void ShowTips(string content)
    {
        ...
        LuaTimerManager.instance.Invoke(0.5f, () => 
        {
