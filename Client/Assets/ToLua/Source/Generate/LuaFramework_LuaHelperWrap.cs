...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetLuaTimerManager", GetLuaTimerManager);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetLuaTimerManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			LuaTimerManager o = LuaFramework.LuaHelper.GetLuaTimerManager();
	...
	static int GetBattleMgr(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			LuaBattleManager o = LuaFramework.LuaHelper.GetBattleMgr();
			ToLua.PushObject(L, o);
			return 1;
		}
		catch (Exception e)
