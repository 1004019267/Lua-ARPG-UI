...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<SocketModel>), factory.System_Action_SocketModel);
		...
		DelegateTraits<System.Action<SocketModel>>.Init(factory.System_Action_SocketModel);
		...
		TypeTraits<System.Action<SocketModel>>.Init(factory.Check_System_Action_SocketModel);
		...
		StackTraits<System.Action<SocketModel>>.Push = factory.Push_System_Action_SocketModel;
	}
	...
	class System_Action_SocketModel_Event : LuaDelegate
	{
		public System_Action_SocketModel_Event(LuaFunction func) : base(func) { }
		public System_Action_SocketModel_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(SocketModel param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(SocketModel param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<SocketModel> System_Action_SocketModel(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<SocketModel> fn = delegate(SocketModel param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_SocketModel_Event target = new System_Action_SocketModel_Event(func);
			System.Action<SocketModel> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_SocketModel_Event target = new System_Action_SocketModel_Event(func, self);
			System.Action<SocketModel> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_SocketModel(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<SocketModel>), L, pos);
	}

	void Push_System_Action_SocketModel(IntPtr L, System.Action<SocketModel> o)
	{
		ToLua.Push(L, o);
	}
