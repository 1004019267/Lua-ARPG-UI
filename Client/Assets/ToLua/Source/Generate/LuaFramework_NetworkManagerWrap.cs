...
public class LuaFramework_NetworkManagerWrap
{
	...
	{
		L.BeginClass(typeof(LuaFramework.NetworkManager), typeof(UnityEngine.MonoBehaviour));
	...
	static int set_Instance(IntPtr L)
	{
		try
		{
			LuaFramework.NetworkManager arg0 = (LuaFramework.NetworkManager)ToLua.CheckObject<LuaFramework.NetworkManager>(L, 2);
			LuaFramework.NetworkManager.Instance = arg0;
			return 0;
		}
		catch (Exception e)
		{
