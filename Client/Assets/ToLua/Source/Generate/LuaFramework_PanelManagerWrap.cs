...
public class LuaFramework_PanelManagerWrap
{
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.Push(L, LuaFramework.PanelManager.Instance);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_Instance(IntPtr L)
	{
		try
		{
			LuaFramework.PanelManager arg0 = (LuaFramework.PanelManager)ToLua.CheckObject<LuaFramework.PanelManager>(L, 2);
			LuaFramework.PanelManager.Instance = arg0;
			return 0;
		}
		catch (Exception e)
		{
