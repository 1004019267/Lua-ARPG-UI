...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaTimerManagerWrap.Register(L);
		LuaBattleManagerWrap.Register(L);
		LuaInterface_DebuggerWrap.Register(L);
		Singleton_LuaTimerManagerWrap.Register(L);
		Singleton_LuaBattleManagerWrap.Register(L);
		L.BeginModule("MyCustom");
		MyCustom_CSharpTestWrap.Register(L);
		L.EndModule();
		...
		L.RegFunction("Action_SocketModel", System_Action_SocketModel);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_SocketModel(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<SocketModel>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<SocketModel>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
