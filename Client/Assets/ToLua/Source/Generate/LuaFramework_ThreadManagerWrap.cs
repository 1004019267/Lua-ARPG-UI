...
public class LuaFramework_ThreadManagerWrap
{
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.Push(L, LuaFramework.ThreadManager.Instance);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_Instance(IntPtr L)
	{
		try
		{
			LuaFramework.ThreadManager arg0 = (LuaFramework.ThreadManager)ToLua.CheckObject<LuaFramework.ThreadManager>(L, 2);
			LuaFramework.ThreadManager.Instance = arg0;
			return 0;
		}
		catch (Exception e)
		{
