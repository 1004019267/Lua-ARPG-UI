...
local MSGTIPS_CHARCREATEFALSE_ENUM = protobuf.EnumValueDescriptor();
...
local CHARACTERDTO_POS_FIELD = protobuf.FieldDescriptor();
...
MSGTIPS_CHARCREATEFALSE_ENUM.name = "CharCreateFalse"
MSGTIPS_CHARCREATEFALSE_ENUM.index = 16
MSGTIPS_CHARCREATEFALSE_ENUM.number = 1017
MSGTIPS_EQUIPSUCCESS_ENUM.name = "EquipSuccess"
MSGTIPS_EQUIPSUCCESS_ENUM.index = 17
MSGTIPS_EQUIPSUCCESS_ENUM.number = 1021
MSGTIPS_UNLOADSUCCESS_ENUM.name = "UnloadSuccess"
MSGTIPS_UNLOADSUCCESS_ENUM.index = 18
MSGTIPS_UNLOADSUCCESS_ENUM.number = 1022
MSGTIPS_DELETEITEMSUCCESS_ENUM.name = "DeleteItemSuccess"
MSGTIPS_DELETEITEMSUCCESS_ENUM.index = 19
MSGTIPS_DELETEITEMSUCCESS_ENUM.number = 1023
MSGTIPS_DELETEMAILSUCCESS_ENUM.name = "DeleteMailSuccess"
MSGTIPS_DELETEMAILSUCCESS_ENUM.index = 20
MSGTIPS_DELETEMAILSUCCESS_ENUM.number = 1031
MSGTIPS_RECVITEMSUCCESS_ENUM.name = "RecvItemSuccess"
MSGTIPS_RECVITEMSUCCESS_ENUM.index = 21
MSGTIPS_RECVITEMSUCCESS_ENUM.number = 1032
MSGTIPS_BUYGOODSSUCCESS_ENUM.name = "BuyGoodsSuccess"
MSGTIPS_BUYGOODSSUCCESS_ENUM.index = 22
MSGTIPS_BUYGOODSSUCCESS_ENUM.number = 1041
MSGTIPS_GOLDNOTENOUGH_ENUM.name = "GoldNotEnough"
MSGTIPS_GOLDNOTENOUGH_ENUM.index = 23
MSGTIPS_GOLDNOTENOUGH_ENUM.number = 1042
MSGTIPS_DIAMONDNOTENOUGH_ENUM.name = "DiamondNotEnough"
MSGTIPS_DIAMONDNOTENOUGH_ENUM.index = 24
MSGTIPS_DIAMONDNOTENOUGH_ENUM.number = 1043
MSGTIPS.name = "MsgTips"
MSGTIPS.full_name = ".common.MsgTips"
MSGTIPS.values = {MSGTIPS_NOACCOUNT_ENUM,MSGTIPS_ACCOUNTHASONLINE_ENUM,MSGTIPS_PASSWORDERROR_ENUM,MSGTIPS_INPUTERROR_ENUM,MSGTIPS_LOGINSUCCESS_ENUM,MSGTIPS_REGISTERSUCCESS_ENUM,MSGTIPS_ACCOUNTREPEAT_ENUM,MSGTIPS_ACCOUNTINVALID_ENUM,MSGTIPS_PASSWORDINVALID_ENUM,MSGTIPS_ACCOUNTOFFLINE_ENUM,MSGTIPS_CHARCREATESUCCESS_ENUM,MSGTIPS_NAMEREPEAT_ENUM,MSGTIPS_CHARONLINESUCCESS_ENUM,MSGTIPS_CHAROFFLINESUCCESS_ENUM,MSGTIPS_DELETECHARSUCCESS_ENUM,MSGTIPS_CHARHASONLINE_ENUM,MSGTIPS_CHARCREATEFALSE_ENUM,MSGTIPS_EQUIPSUCCESS_ENUM,MSGTIPS_UNLOADSUCCESS_ENUM,MSGTIPS_DELETEITEMSUCCESS_ENUM,MSGTIPS_DELETEMAILSUCCESS_ENUM,MSGTIPS_RECVITEMSUCCESS_ENUM,MSGTIPS_BUYGOODSSUCCESS_ENUM,MSGTIPS_GOLDNOTENOUGH_ENUM,MSGTIPS_DIAMONDNOTENOUGH_ENUM}
...
CHARACTERDTO_ACCOUNTID_FIELD.default_value = ""
CHARACTERDTO_ACCOUNTID_FIELD.type = 9
CHARACTERDTO_ACCOUNTID_FIELD.cpp_type = 9
